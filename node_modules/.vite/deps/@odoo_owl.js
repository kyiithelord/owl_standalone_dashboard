...
var TemplateSet = class {
  constructor(config2 = {}) {
    ...
    this.customDirectives = config2.customDirectives || {};
    this.runtimeUtils = { ...helpers, __globals__: config2.globalValues || {} };
    this.hasGlobalValues = Boolean(config2.globalValues && Object.keys(config2.globalValues).length);
  }
...
${code}`;
  ...
  compileComponent(ast, ctx) {
    ...
    const props = ast.props ? this.formatPropObject(ast.props, ast.propsTranslationCtx, ctx.translationCtx) : [];
    let slotDef = "";
    if (ast.slots) {
      let ctxStr = "ctx";
  ...
  compileTSlot(ast, ctx) {
    ...
    const props = ast.attrs ? this.formatPropObject(attrs, ast.attrsTranslationCtx, ctx.translationCtx) : [];
...
function parseTTranslation(node, ctx) {
  ...
  if ((result === null || result === void 0 ? void 0 : result.type) === 3) {
...
function makeASTMulti(children) {
  const ast = { type: 3, content: children };
...
//# sourceMappingURL=@odoo_owl.js.map
